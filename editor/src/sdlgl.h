...
#define SDLGL_TYPE_LABEL       0x13 
#define SDLGL_TYPE_VALUE       0x14     /* Print a value given in field     */ 
...
typedef struct {
    ...
    char code;	    /* Code from INPUTVEC, if in a rect	        */
                    ...
                    /* translation, size for EDIT               */
    char sub_code;  /* Additional code for input, type for EDIT */
    			    /* ------ Mouse related stuff ------------- */
    ...
    int  fps;       /* Actual displayed frames per second       */
    int  sdlcode;	/* SDLK_... code			                */
    int  modflags;  /* Flags of mod keys			            */
    			    /* SDL_BUTTON_... if SDLGL_INP_MOUSE	    */
    char text_key;  /* 'Cooked' version of the input key        */
                    /* e.g Shift-Key translates 'a' -> 'A'      */
