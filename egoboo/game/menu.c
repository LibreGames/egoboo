...
int doGameOptions( float deltaTime )
{
    ...
    switch ( menuState )
    {
        ...
        case MM_Entering:
            ...
            sz_buttons[6] = cfg.xpbar_allowed ? "On" : "Off";
        ...
        case MM_Running:
            ...
            // Show the fps?
            ui_drawTextBox( menuFont, "Display XP Bar:", buttonLeft + 350, 300, 0, 0, 20 );
            if ( BUTTON_UP == ui_doButton( 7, sz_buttons[6], menuFont, buttonLeft + 515, 300, 100, 30 ) )
            {
                cfg.xpbar_allowed = !cfg.xpbar_allowed;
                if ( cfg.xpbar_allowed )   sz_buttons[6] = "On";
...
int doVideoOptions( float deltaTime )
{
    ...
    switch ( menuState )
    {
        ...
        case MM_Running:
            ...
            if ( PMod->active )
            {
                snprintf( Cmaxparticles, SDL_arraysize( Cmaxparticles ), "%d (%d currently used)", maxparticles, maxparticles - prt_count_free() );
