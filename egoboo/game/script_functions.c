...
Uint8 scr_HoldingRangedWeapon( script_state_t * pstate, ai_state_t * pself )
{
    ...
    if ( INGAME_CHR( ichr ) )
    {
        ...
        //if ( NULL != pcap && pcap->isranged) printf("%s ammo %d/%d (known %d) (right) ", ChrList.lst[ichr].Name, ChrList.lst[ichr].ammo, ChrList.lst[ichr].ammomax, ChrList.lst[ichr].ammoknown == btrue);
    ...
    if ( !returncode )
    {
        ...
        if ( INGAME_CHR( ichr ) )
        {
            ...
            //if ( NULL != pcap && pcap->isranged) printf("%s ammo %d/%d (left) ", ChrList.lst[ichr].Name, ChrList.lst[ichr].ammo, ChrList.lst[ichr].ammomax);
        ...
        //printf("result %d (argument = %d) update_wld = %d\n", returncode == btrue, pstate->argument, update_wld);
