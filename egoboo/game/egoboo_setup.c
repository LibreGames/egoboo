...
void egoboo_config_init( egoboo_config_t * pcfg )
{
    ...
    pcfg->xpbar_allowed         = btrue;            // Show XP bar?
...
bool_t setup_download( egoboo_config_t * pcfg )
{
    ...
    GetKey_bool( "DISPLAY_XPBAR", pcfg->xpbar_allowed, cfg_default.xpbar_allowed );
...
bool_t setup_upload( egoboo_config_t * pcfg )
{
    ...
    SetKey_bool( "DISPLAY_XPBAR", pcfg->xpbar_allowed );
