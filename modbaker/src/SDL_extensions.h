...
#define BIT_TO_BOOL(X)       ((X==1) ? SDL_TRUE : SDL_FALSE )
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
	struct s_ogl_video_parameters;

//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
// SDL graphics info
	struct s_sdl_screen_info
	{
...
//------------------------------------------------------------------------------
	...
	typedef struct s_sdl_video_parameters sdl_video_parameters_t;
...
//------------------------------------------------------------------------------
	...
	extern sdl_screen_info_t sdl_scr;
...
//------------------------------------------------------------------------------
	...
	sdl_video_parameters_t * sdl_set_mode(sdl_video_parameters_t * v_old, sdl_video_parameters_t * v_new, struct s_ogl_video_parameters * gl_new);
