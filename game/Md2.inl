...
INLINE const int md2_get_numSkins(MD2_Model_t * m)     { return m->m_numSkins; }
INLINE const int md2_get_numFrames(MD2_Model_t * m)    { return m->m_numFrames; }
...
INLINE const MD2_SkinName_t  *md2_get_SkinNames(MD2_Model_t * m) { return m->m_skins;     }
INLINE const MD2_TexCoord_t  *md2_get_TexCoords(MD2_Model_t * m) { return m->m_texCoords; }
INLINE const MD2_Triangle_t  *md2_get_Triangles(MD2_Model_t * m) { return m->m_triangles; }
INLINE const MD2_Frame_t     *md2_get_Frames   (MD2_Model_t * m) { return m->m_frames;    }
INLINE const MD2_GLCommand_t *md2_get_Commands (MD2_Model_t * m) { return m->m_commands;  }
