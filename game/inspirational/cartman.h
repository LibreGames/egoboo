...
#define CARTMAN_VERSION 005       ///< Version number
#define CARTMAN_YEAR 1999         ///< Year
#define CARTMAN_NAME "Cartman"    ///< Program name
...
#define FIXNUM    4.125   ///< Magic number
...
#define MAXTOTALMESHVERTICES   (128*128*6)  
