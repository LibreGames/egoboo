...
void	operator delete(void *reportedAddress)
{
	...
	if (reportedAddress) m_freeator(sourceFile, sourceLine, sourceFunc, m_alloc_delete, reportedAddress);
...
void	operator delete[](void *reportedAddress)
{
	...
	if (reportedAddress) m_freeator(sourceFile, sourceLine, sourceFunc, m_alloc_delete_array, reportedAddress);
...
void	m_freeator(const char *sourceFile, const unsigned int sourceLine, const char *sourceFunc, const unsigned int deallocationType, const void *reportedAddress)
{
	try
	{
		#ifdef TEST_MEMORY_MANAGER
