...
// function prototypes
    ...
    bool_t copy_file_to_delimiter( vfs_FILE * fileread, vfs_FILE * filewrite, const int delim, char * buffer, const size_t bufflen );
    ...
    Uint32  ego_texture_load_vfs( struct s_oglx_texture *texture, const char *filename, const Uint32 key );
