...
bool_t fput_next_message( FILE* filewrite, const char * comment, struct sMessageData * data, int num  );
...
EGO_CONST char * inherit_fname(const char * szObjPath, const char * szObject, const char *szFname );
