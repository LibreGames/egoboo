...
#define DEFINED_CHR( ICHR )     ( VALID_PBASE(ChrObjList.get_valid_ptr(ICHR) ) && !FLAG_KILLED_PBASE(ChrObjList.get_valid_ptr(ICHR)) )
...
#define DEFINED_PCHR( PCHR )     ( VALID_PBASE(PDATA_CGET_PBASE( ego_chr, PCHR ) ) && !FLAG_KILLED_PBASE(PDATA_CGET_PBASE( ego_chr, PCHR )) )
